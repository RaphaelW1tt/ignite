...
class IgniteRDD[K, V] (
    ...
    val keepBinary: Boolean) extends IgniteAbstractRDD[(K, V), K, V] (ic, cacheName, cacheCfg, keepBinary) {
    /**
...
class IgniteRDDPageSize[K, V] (
     ...
     * @return New `IgniteRDD` instance for binary objects.
     */
    def withKeepBinary[K1, V1](): IgniteRDDPageSize[K1, V1] = {
        new IgniteRDDPageSize[K1, V1](
            ic,
            cacheName,
            cacheCfg.asInstanceOf[CacheConfiguration[K1, V1]],
            true,
